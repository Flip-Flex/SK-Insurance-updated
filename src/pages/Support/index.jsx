    ...
    <div className="min-h-screen bg-[#F7F7F5] dark:bg-[#000000] text-black dark:text-white pt-24 pb-24 font-sans transition-colors duration-300">
      ...
      <section className="relative px-4 sm:px-8 max-w-7xl mx-auto pb-20 border-b border-black/10 dark:border-white/10 overflow-hidden transition-colors">
        ...
        >
          <div className="lg:col-span-8">
            <span className="text-xs text-[#8A9200] dark:text-[#F6FF00] uppercase tracking-widest font-bold">We're Here to Help</span>
          ...
          <div className="lg:col-span-4 flex lg:justify-end">
            <a 
              ...
              className="w-full lg:w-auto px-8 py-5 bg-black dark:bg-white text-white dark:text-black font-bold uppercase tracking-widest text-xs rounded-xl hover:bg-[#C9D100] dark:hover:bg-[#F6FF00] hover:text-black transition-colors flex items-center justify-center gap-3 shadow-lg dark:shadow-none"
            >
      ...
      <section className="px-4 sm:px-8 max-w-7xl mx-auto py-16 border-b border-black/10 dark:border-white/10 transition-colors">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <a href="tel:+919994451300" className="bg-white dark:bg-[#0A0A0A] border border-black/10 dark:border-white/10 rounded-2xl p-6 hover:border-black/30 dark:hover:border-white/20 hover:shadow-lg dark:hover:shadow-none transition-all group shadow-sm dark:shadow-none">
            <div className="w-11 h-11 rounded-xl bg-[#C9D100]/15 dark:bg-[#F6FF00]/10 flex items-center justify-center text-[#8A9200] dark:text-[#F6FF00] mb-5 group-hover:bg-[#C9D100] dark:group-hover:bg-[#F6FF00] group-hover:text-black transition-colors">
              <FaPhoneAlt />
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 bg-white dark:bg-[#0A0A0A] border border-black/10 dark:border-white/10 rounded-2xl p-8 sm:p-10 shadow-sm dark:shadow-none flex flex-col justify-between transition-colors">
            ...
            <div className="flex items-center gap-3 pt-6 border-t border-black/5 dark:border-white/5">
              <div className="w-9 h-9 rounded-full bg-[#C9D100]/15 dark:bg-[#F6FF00]/10 flex items-center justify-center text-[#8A9200] dark:text-[#F6FF00] shrink-0">
          ...
          <div className="lg:col-span-7 bg-black dark:bg-[#111111] text-white border border-transparent dark:border-white/10 rounded-2xl p-8 sm:p-12 shadow-lg dark:shadow-none relative overflow-hidden flex flex-col justify-between transition-colors">
            <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-[#C9D100]/20 dark:bg-[#F6FF00]/10 rounded-full blur-[100px] pointer-events-none" />
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-9 h-9 rounded-full bg-[#C9D100] dark:bg-[#F6FF00] flex items-center justify-center text-black shrink-0">
                  <FaCalendarAlt className="text-sm" />
                </div>
                <span className="text-[#C9D100] dark:text-[#F6FF00] text-xs font-bold uppercase tracking-widest">Book a Session</span>
              </div>
            ...
            <Link
              to="/appointment"
              className="relative z-10 w-full sm:w-fit px-8 py-4 bg-[#C9D100] dark:bg-[#F6FF00] text-black font-bold uppercase tracking-widest text-xs rounded-xl hover:bg-white transition-colors text-center whitespace-nowrap flex items-center justify-center gap-2"
            >
      ...
      <section className="px-4 sm:px-8 max-w-7xl mx-auto py-16 border-b border-black/10 dark:border-white/10 transition-colors">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="flex items-start gap-4 p-2">
            <div className="w-11 h-11 rounded-full bg-[#C9D100]/15 dark:bg-[#F6FF00]/10 flex items-center justify-center text-[#8A9200] dark:text-[#F6FF00] shrink-0">
              <FaShieldAlt />
            </div>
            <div>
        ...
        <section className="px-4 sm:px-8 max-w-7xl mx-auto pt-20 transition-colors">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-black dark:text-white tracking-tight mb-4">
              Got <span className="text-[#8A9200] dark:text-[#F6FF00]">Questions?</span>
            </h2>
            ...
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  ...
                  <div className={`p-2 rounded-full shrink-0 transition-all duration-300 ${openFaq === idx ? 'bg-[#C9D100] dark:bg-[#F6FF00] text-black rotate-180' : 'bg-black/5 dark:bg-[#111111] text-black/50 dark:text-white/50'}`}>
      ...
      <section className="px-4 sm:px-8 max-w-7xl mx-auto pt-24 transition-colors">
        <div className="bg-black dark:bg-[#0A0A0A] text-white rounded-2xl p-10 sm:p-16 text-center relative overflow-hidden shadow-xl dark:shadow-none border border-transparent dark:border-white/10 transition-colors">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[300px] bg-[#C9D100]/15 dark:bg-[#F6FF00]/5 rounded-full blur-[100px] pointer-events-none" />
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a 
                href="https://wa.me/919994451300?text=Hi%20SK%20Smart%20Investments%2C%20I%20have%20a%20query%20about%20your%20services."
                target="_blank" rel="noopener noreferrer"
                className="px-8 py-4 bg-[#C9D100] dark:bg-[#F6FF00] text-black font-bold uppercase tracking-widest text-xs rounded-xl hover:bg-white transition-colors flex items-center justify-center gap-2"
              >
