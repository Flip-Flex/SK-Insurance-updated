...
export const Footer = () => {
  ...
  return (
    <footer className="relative bg-black text-white pt-20 pb-10 overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                { name: "Health Platinum Cover", path: "/plans?category=Health" },
                { name: "Term Life Elite", path: "/plans?category=Life" },
                { name: "Auto Max Cover", path: "/plans?category=Motor" },
                { name: "Safe Haven Home Policy", path: "/plans?category=Home" },
              ].map((link, idx) => (
                <li key={idx}>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={idx}>
                  <Link to={link.path} className={`group flex items-center gap-2 text-sm font-medium transition-colors ${link.highlight ? 'text-brand-accent hover:text-brand-accent/80 drop-shadow-[0_0_10px_rgba(246,255,0,0.3)]' : 'text-neutral-400 hover:text-white'}`}>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-xs text-neutral-500 font-[900] uppercase tracking-widest">
